...
const Toolbar = () => {
  ...
  return (
    <div className="bg-[#F1F4F9] px-2.5 py-2.5 rounded-[24px] min-h-[40px] flex items-center justify-between gap-x-0.5 overflow-x-auto">
      {sections[0].map((item)=> (
